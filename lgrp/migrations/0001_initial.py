# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-26 22:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collecting_method', models.CharField(choices=[('Survey', 'Survey'), ('Wet Screen', 'Wet Screen'), ('Crawl survey', 'Crawl survey'), ('Transect survey', 'Transect survey'), ('Dry Screen', 'Dry Screen'), ('Excavation', 'Excavation')], max_length=50, null=True)),
                ...
                ('old_cat_number', models.CharField(blank=True, max_length=255, null=True)),
