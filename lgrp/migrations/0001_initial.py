# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2018-01-07 23:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'LGRP ID Qualifiers',
            },
        ),
        migrations.CreateModel(
            name='Image',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_code', models.CharField(blank=True, choices=[('AA', 'AA'), ('AM', 'AM'), ('AM12', 'AM12'), ('AS', 'AS'), ('AT', 'AT'), ('BD', 'BD'), ('BG', 'BG'), ('BR', 'BR'), ('DK', 'DK'), ('FD', 'FD'), ('GR', 'GR'), ('HD', 'HD'), ('HS', 'HS'), ('KG', 'KG'), ('KL', 'KL'), ('KT', 'KT'), ('LD', 'LD'), ('LG', 'LG'), ('LN', 'LN'), ('LS', 'LS'), ('MF', 'MF'), ('NL', 'NL'), ('OI', 'OI'), ('SS', 'SS')], max_length=20, null=True, verbose_name='Coll Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem_comment', models.TextField(blank=True, help_text='Description of the problem.', max_length=255, null=True)),
                ('remarks', models.TextField(blank=True, help_text='General remarks about this database record.', max_length=500, null=True, verbose_name='Record Remarks')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='lgrp.Taxon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identified_by', models.CharField(blank=True, choices=[('D. Braun', 'D. Braun'), ('J. Thompson', 'J. Thompson'), ('E. Scott', 'E. Scott'), ('E. Locke', 'E. Locke'), ('A.E. Shapiro', 'A.E. Shapiro'), ('A.W. Gentry', 'A.W. Gentry'), ('B.J. Schoville', 'B.J. Schoville'), ('B.M. Latimer', 'B.M. Latimer'), ('C. Denys', 'C. Denys'), ('C.A. Lockwood', 'C.A. Lockwood'), ('D. Geraads', 'D. Geraads'), ('D.C. Johanson', 'D.C. Johanson'), ('E. Delson', 'E. Delson'), ('E.S. Vrba', 'E.S. Vrba'), ('F.C. Howell', 'F.C. Howell'), ('G. Petter', 'G. Petter'), ('G. Suwa', 'G. Suwa'), ('G.G. Eck', 'G.G. Eck'), ('H.B. Krentza', 'H.B. Krentza'), ('H.B. Wesselman', 'H.B. Wesselman'), ('H.B.S. Cooke', 'H.B.S. Cooke'), ('Institute Staff', 'Institute Staff'), ('J.C. Rage', 'J.C. Rage'), ('K.E. Reed', 'K.E. Reed'), ('L.A. Werdelin', 'L.A. Werdelin'), ('L.J. Flynn', 'L.J. Flynn'), ('M. Sabatier', 'M. Sabatier'), ('M.E. Lewis', 'M.E. Lewis'), ('N. Fessaha', 'N. Fessaha'), ('P. Brodkorb', 'P. Brodkorb'), ('R. Bobe-Quinteros', 'R. Bobe-Quinteros'), ('R. Geze', 'R. Geze'), ('R.L. Bernor', 'R.L. Bernor'), ('S.R. Frost', 'S.R. Frost'), ('T.D. White', 'T.D. White'), ('T.K. Nalley', 'T.K. Nalley'), ('V. Eisenmann', 'V. Eisenmann'), ('W.H. Kimbel', 'W.H. Kimbel'), ('Z. Alemseged', 'Z. Alemseged'), ('S. Oestmo', 'S. Oestmo'), ('J. Rowan', 'J. Rowan'), ('C.J. Campisano', 'C.J. Campisano'), ('J. Robinson', 'J. Robinson'), ('I. Smail', 'I. Smail'), ('I. Lazagabaster', 'I. Lazagabaster')], max_length=100, null=True)),
        ...
        migrations.AddField(
            model_name='taxon',
            name='rank',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lgrp.TaxonRank'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='image',
            name='occurrence',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lgrp_occurrences', to='lgrp.Occurrence'),
        ),
        migrations.AddField(
            model_name='file',
            name='occurrence',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lgrp.Occurrence'),
        ),
        migrations.AddField(
            model_name='biology',
            name='qualifier_taxon',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lgrp_qualifier_taxon_bio_occurrences', to='lgrp.Taxon'),
        ),
        migrations.AddField(
            model_name='biology',
            name='taxon',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='lgrp_taxon_bio_occurrences', to='lgrp.Taxon'),
        ),
    ]
