...
class OccurrenceMethodTests(TestCase):
    ...
    def test_get_all_field_names(self):
        ...
        self.assertEqual(len(field_names_list), 54)  # check the length of the field name list.
    ...
    def test_get_foreign_key_field_names(self):
        ...
        self.assertEqual(len(foreign_key_list), 8)
    ...
    def test_get_concrete_field_names(self):
        ...
        self.assertEqual(len(concrete_field_list), 49)
