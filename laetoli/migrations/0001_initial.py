    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verbatim_specimen_number', models.CharField(blank=True, max_length=255, null=True, verbose_name='cat_number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='laetoli.Taxon')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Fossil',
            fields=[
                ('find_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='laetoli.Find')),
                ...
                ('taxon_remarks', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.AddField(
            model_name='taxon',
            name='rank',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='laetoli.TaxonRank'),
        ),
    ]
