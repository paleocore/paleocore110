# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-26 21:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_number', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='drp.Taxon')),
            ],
            options={
                'verbose_name': 'Taxon',
        ...
        migrations.AddField(
            model_name='taxon',
            name='rank',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='drp.TaxonRank'),
        ),
        migrations.AddField(
            model_name='occurrence',
            name='locality',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='drp.Locality'),
        ),
        migrations.AddField(
            model_name='image',
            name='occurrence',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='drp_occurrences', to='drp.Occurrence'),
        ),
        migrations.AddField(
            model_name='file',
            name='occurrence',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='drp.Occurrence'),
        ),
        migrations.AddField(
            model_name='biology',
            name='taxon',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='drp_biology_occurrences', to='drp.Taxon'),
        ),
    ]
